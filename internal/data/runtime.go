...
// Declare a custom Runtime type, which has the underlying type int (the same as our
// Movie struct field).
type Runtime int
...
func (r *Runtime) UnmarshalJSON(jsonValue []byte) error {
	...
	// Otherwise, parse the string containing the number into an int. Again, if this
	...
	// Convert the int to a Runtime type and assign this to the receiver. Note that we
